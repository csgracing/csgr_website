        ...
        <nav className='sticky z-1 top-0 w-full flex items-center justify-between border-b-3 border-csg-red bg-black uppercase'>
                ...
                {pages.map((page,index) => (
                            <div className='' key={index}>
                                ...
                                <Link
                                    href={page.link}
                                    className="
                                            flex px-3 py-4 text-center md:text-left text-lg
            ...
            <ul className='flex gap-2 not-2xl:hidden mx-5'>
                ...
                <a href='https://www.instagram.com/csg.racing/'>
                    <InstaLogo className='w-12 h-12 transition duration-300 fill-white hover:fill-csg-red hover:scale-115'/>
                </a>
                <a href='https://www.tiktok.com/@csg.racing'>
                    <TiktokLogo className='w-12 h-12 transition duration-300 fill-white hover:fill-csg-red hover:scale-115'/>
                </a>
                <a href='https://www.linkedin.com/company/csgracing/'>
                    <LinkedinLogo className='w-12 h-12 transition duration-300  fill-white hover:fill-csg-red hover:scale-115'/>
                </a>
                <a href='https://www.facebook.com/profile.php?id=61583516661171'>
                    <FacebookLogo className='w-12 h-12 transition duration-300 fill-white hover:fill-csg-red hover:scale-115'/>
                </a>
                </ul>
