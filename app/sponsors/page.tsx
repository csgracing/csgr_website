...
export default function sponsors() {
  ...
  return (
    <div className=' text-center py-4'>
      ...
      <div className=''>
        <Link href='sponsorBrochure.pdf' className='justify-center flex m-5'><p className='bg-csg-red px-4 py-2 rounded-lg text-2xl transition duration 300 hover:scale-120 '>Download Our Sponsor Brochure</p></Link>
      </div>
        <SponsorGrid/>
    </div>
  );
