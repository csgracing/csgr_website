    ...
    <div>
     ...
     <ul className=''>
      ...
      <a href="https://www.imeche.org/events/formula-student" className='justify-center flex m-5'>
        <p className='align-center bg-csg-light-gray border-3 border-csg-red inline  rounded-lg text-center text-xl transition duration 300 hover:scale-120'>learn more</p>
      </a>
      </div>
     </ul>
